...
public class BucketTool extends Tool {
    ...
    public BucketTool(DrawingLayer drawingLayer) {
        super(drawingLayer);
        this.name = "Fill";
        paint = new Paint();
    }
    ...
    protected void getReady() {
        fillColor = this.drawingLayer.getCurrentColor();
    }
    ...
    public void commitToBitmap(int id, Bitmap bitmap) {
        PointF stopPt = curPointsById.get(id);
        QueueLinearFloodFiller filler = new QueueLinearFloodFiller(bitmap, 0, fillColor);
        filler.setTolerance(10);
        filler.floodFill((int)stopPt.x, (int)stopPt.y);
        filler = null;
        System.gc();
    }

    // Copied from http://stackoverflow.com/questions/8070401/android-flood-fill-algorithm
    // which is based on http://www.codeproject.com/Articles/16405/Queue-Linear-Flood-Fill-A-Fast-Flood-Fill-Algorith
